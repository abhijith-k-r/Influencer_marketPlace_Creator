        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(backgroundColor: CreatorColors.primary, foregroundColor: CreatorColors.onPrimary, shape: const RoundedRectangleBorder(borderRadius: AppRadii.roundedMd), padding: const EdgeInsets.symmetric(vertical: 14)),
      ...
      children: [
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: CreatorColors.primary, foregroundColor: CreatorColors.onPrimary, disabledBackgroundColor: CreatorColors.primary.withValues(alpha: 0.6), shape: const RoundedRectangleBorder(borderRadius: AppRadii.roundedMd), padding: const EdgeInsets.symmetric(vertical: 14)),
            child: _isLoading
                ? const AppProgressIndicator.inline(size: 22, strokeWidth: 2.5)
